...
**Frontend:** ReactJS, AngularJS, HTML, CSS, JavaScript, TypeScript, Figma
**Backend & Databases:** Node.js, Django, ASP.NET Core, REST APIs, PostgreSQL, SQL, PHP
**Cloud & Infra:** AWS, Docker, Firebase, Azure DevOps, CI/CD
**Testing:** Python Robot Framework, Selenium, Postman
**DSA:** 1000+ problems solved across competitive programming platforms
